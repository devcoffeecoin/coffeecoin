...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("COFFEECOIN Core"),
     ...
     * override -datadir in the coffeecoin.conf file in the default data directory
     * (to be consistent with coffeecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
