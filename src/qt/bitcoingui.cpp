                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("COFFEECOIN-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About COFFEECOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about COFFEECOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for COFFEECOIN"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the COFFEECOIN Core help message to get a list with possible COFFEECOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("COFFEECOIN Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("COFFEECOIN Core"); // default title
