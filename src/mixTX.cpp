...
/* *** BEGIN DARKSEND MAGIC - COFFEECOIN **********
    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat COFFEECOIN and make it unusable. To
                stop these kinds of attacks 1 in 10 successful transactions are charged. This
                adds up to a cost of 0.001 COFFEECOIN per transaction on average.
            */
            if (r <= 10) {
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeCOFFEECOINAmount * COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckDarKsendPool()
{
    ...
    RenameThread("coffeecoin-Darksend");
