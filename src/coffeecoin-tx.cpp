...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("COFFEECOIN Core coffeecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  coffeecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coffeecoin transaction") + "\n" +
                               "  coffeecoin-tx [options] -create [commands]   " + _("Create hex-encoded coffeecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coffeecoin transaction
