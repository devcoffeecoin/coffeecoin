...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* COFFEECOIN features */
        {"coffeecoin", "masternode", &masternode, true, true, false},
        {"coffeecoin", "masternodelist", &masternodelist, true, true, false},
        {"coffeecoin", "mnbudget", &mnbudget, true, true, false},
        {"coffeecoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"coffeecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"coffeecoin", "mnsync", &mnsync, true, true, false},
        {"coffeecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"coffeecoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use coffeecoind, or the -server option to coffeecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
