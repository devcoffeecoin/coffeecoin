...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("COFFEECOINMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("COFFEECOINMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("COFFEECOINMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        if (fProofOfStake) {
            ...
            if (!pblock->SignBlock(*pwallet)) {
                LogPrintf("COFFEECOINMiner(): Signing new block failed \n");
                continue;
            }
        ...
        LogPrintf("Running COFFEECOINMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void static ThreadBitcoinMiner(void* parg)
{
    ...
    try {
        ...
        LogPrintf("ThreadCOFFEECOINMiner() exception");
    } catch (...) {
        LogPrintf("ThreadCOFFEECOINMiner() exception");
    }

    LogPrintf("ThreadCOFFEECOINMiner exiting\n");
}
