...
In order to support loading of multiple wallets in coffeecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is coffeecoin.cpp.
...
Changes to coffeecoin.cpp
----------------------
coffeecoin.cpp is the entry point into coffeecoin-qt, and as such, will require some minor modifications to provide hooks for
