...
COFFEECOIN now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<coffeecoin_address\> \<monthly_payment_coffeecoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ COFFEECOIN, _12_ times over the course of a year totaling _24000_ COFFEECOIN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<coffeecoin_address\> \<monthly_payment_coffeecoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` COFFEECOIN.
 ...
 * vote-many          - Vote on a COFFEECOIN initiative
 * vote-alias         - Vote on a COFFEECOIN initiative
 * vote               - Vote on a COFFEECOIN initiative/budget
